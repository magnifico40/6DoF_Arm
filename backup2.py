...
def display():
    ...
    draw_text(250, 570, f"XYZ1: {FirstJointXYZ[0]:.2f}, {FirstJointXYZ[1]:.2f}, {FirstJointXYZ[2]:.2f}")
    draw_text(250, 545, f"XYZ2: {SecondJointXYZ[0]:.2f}, {SecondJointXYZ[1]:.2f}, {SecondJointXYZ[2]:.2f}")
    draw_text(250, 520, f"XYZ3: {ThirdJointXYZ[0]:.2f}, {ThirdJointXYZ[1]:.2f}, {ThirdJointXYZ[2]:.2f}")
    draw_text(500, 570, f"XYZ4: {FourthJointXYZ[0]:.2f}, {FourthJointXYZ[1]:.2f}, {FourthJointXYZ[2]:.2f}")
    draw_text(500, 545, f"XYZ7: {SeventhJointXYZ[0]:.2f}, {SeventhJointXYZ[1]:.2f}, {SeventhJointXYZ[2]:.2f}")

...
from RobotArmTarget import RobotArm
...
class MainWindow(QMainWindow):
    ...
    def PickTarget(self):
        ...
        if self.PickTarget_btn.isChecked():
            ...
            targetToPick_x1 = self.x_spinbox_targ.value()   #with 1 original
            ...
            yaw = np.degrees(np.arctan2(targetToPick_y1, targetToPick_x1))
             ...
             #bez tego nie działa xd, później poprawię
            ...
            ypr = [yaw, 90, 180] # pod jakim kątem dochodzimy do celu
